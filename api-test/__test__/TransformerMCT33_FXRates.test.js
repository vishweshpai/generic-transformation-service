...
var flag = true;
const _body = JSON.parse(fs.readFileSync("./requestjson/mct-33.json","UTF-8"));


describe('POST To test Transformation for MCT33 FXRates ', function () {
    var res;
...
describe('To verify Data in the file should be transformed for FXRATES_MCT33', function () {
